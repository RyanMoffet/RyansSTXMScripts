...
function [avspec,recspec,binmap]=Fe_Peak2Peak_Map(S)
        ...
        GrayImage=mat2gray(mean(S.spectr,3)); %% Turn into a greyscale with vals [0 1]
        GrayImage=imadjust(GrayImage,[0 1],[0 1],0.5); %% increase contrast
