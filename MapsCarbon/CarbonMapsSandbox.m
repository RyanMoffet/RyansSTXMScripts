...
%% 
sp2idx=find(energy>285 & energy<285.5)
...
figure,imagesc(carb),colormap gray,colorbar
...
doublecarb1=doublecarb;                  % taking STD of regions not having particles
doublecarb1(doublecarb1<3*doubCarbNois)=0; % removes regions with sp2 less than 6x S/N
...
sp2(sp2<0.4)=0;                                                     % threshold everythin less than 40% sp2
figure,    
imagesc([0, Snew.Xvalue],[0,Snew.Yvalue],sp2),...
    set(gca,'Clim',[0,1.0]),
colorbar
