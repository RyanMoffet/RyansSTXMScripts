function [specout,npix]=ComponentSpecSVD(Sin,comp,plot)
...
if strcmp('COOH',comp)==1
    ...
    exclude=[3];          %% sets the regions to exclude\
...
%% Return output
dimE=size(Energy); %% somehow the energy vector is transposed in some IMPACTS routines
if dimE(2)>1
    Energy=Energy';
    Partspec=Partspec';
end
